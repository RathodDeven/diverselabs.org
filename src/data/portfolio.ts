...
export const portfolioCaseStudies: Doc[] = [
  ...
  /* ───────────────────── N · Packaging, labeling & NDC strategy ───────────────────── */
  {
    ...
    eyebrow: "Oncology · Packaging, labeling & serialization",
  ...
  /* ───────────────────── N · Blister commercialization ───────────────────── */
  {
    ...
    description: "How an oncology biotech planned to design, qualify, and operationalize a launch-ready commercial blister presentation for an oral capsule product, from configuration freeze through primary stability and packaging validation.",
    keywords: "blister commercialization, blister vs bottle, packaging format, forming and lidding film, primary stability batch, PQ PPQ, pack testing",
    eyebrow: "Oncology · Packaging format (blister vs bottle)",
    dek: "How an oncology biotech planned to design, qualify, and operationalize a launch-ready commercial blister presentation for an oral capsule product, from configuration freeze through primary stability and packaging validation.",
    tags: ["Packaging format","Blister","Stability & validation","Launch readiness"],
...
const TIMEFRAMES: Record<string, string> = {
  ...
  'oral-oncology-blister-commercialization': '2025',
